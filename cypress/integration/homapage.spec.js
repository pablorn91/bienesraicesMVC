...
describe('Carga la página principal', () => {
    it('Prueba el Header de la página principal', () => {
        ...
        cy.get('[data-cy="heading-sitio"]').invoke('text').should('not.equal' ,'Bienes narices');
    ...
    it('Prueba la sección de contacto', () => {
        ...
        cy.get('[data-cy="seccion-contacto"]').find('P').invoke('text').should('equal', 'Llena el formulario de contacto y un asesor se pondrá en contacto en la brevedad');
